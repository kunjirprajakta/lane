...
|
| These details are used in Facebook authentication library.
|--------------------------------------------------------------------------
*/
$config['fb_app_id'] = '1296916147085931';
$config['fb_app_secret'] = '7e55b2ce3890745d6540fa61a3571927';
$config['fb_redirectURL'] = base_url().'sociallogin/fblogin/';
/*
|--------------------------------------------------------------------------
| Facebook  Configuration
|
| These details are used in Google authentication library.
|--------------------------------------------------------------------------
*/
$config['google_clientId'] = '565026920839-4qrjca21g8lgiffmq24un2i49fplq8nd.apps.googleusercontent.com';
$config['google_clientSecret'] = 'zYQnTvxtIwgXZZf6g83LIhCU';
$config['google_redirectURL'] = htmlspecialchars(base_url().'index.php/sociallogin/googlelogin/');
/*
|--------------------------------------------------------------------------
| Login setting
|
...
$config['captcha_fonts_path'] = 'captcha/fonts/Capture_it.ttf';
